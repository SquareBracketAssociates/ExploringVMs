...
%=================================================================
\title{Building an Object-Oriented Language Virtual Machine in 72 hours}
\author{
   Cl\'ement B\'era (with St\'ephane Ducasse)}
...
ADD COPYRIGHT
 % Copyright 2015 by Cl\'ement B\'era.
